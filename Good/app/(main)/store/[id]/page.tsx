...
export default function StorePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="py-12">
      ...
      <div className="mt-12">
        <h2 className="mb-8 text-2xl font-bold text-center font-headline md:text-left px-4 lg:px-8">
        ...
        {loading ? (
            ...
            {publicProducts.length > 0 ? (
                ...
                <p className="col-span-full px-4 lg:px-8">This seller has no public products yet.</p>
            )}
            </div>
        )}
      </div>
