...
export default function CollectorCoinsPage() {
    ...
    return (
        <div className="pt-5 pb-12 p-5">
            <h1 className="text-3xl font-bold font-headline">Collector Coins</h1>
            <p className="mt-2 text-muted-foreground">Discover rare and collectible coins.</p>
