...
export default function CollectiblesPage() {
  ...
  }, [sortOrder, selectedCategory, includedSellers, excludedSellers, user, postcode, sellerPostcodeMap]);
  ...
  return (
    <div className="p-5 pt-5 pb-12">
      <h1 className="text-3xl font-bold font-headline">Collectibles</h1>
      <p className="mt-2 text-muted-foreground">Browse all collectible items.</p>
